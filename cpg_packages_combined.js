...
const CPG_PACKAGES = {
  ...
  acs: {
    ...
    management: [
      ...
      { type: "action", text: "GTN 300 mcg S/L — repeat 300 mcg @ 5 minute intervals if hypertension persists" },
  ...
  pulmonary_oedema: {
    ...
    management: [
      ...
      { type: "note", items: ["Signs of fluid overload: Furosemide 20\u201340 mg IV or patient's daily dose IV as single dose (max 80 mg) \u2014 administer en-route to hospital once other treatment established"] },
      ...
      { type: "mica", text: "BiPAP NIV: IPAP 10 cmH\u2082O, EPAP 5 cmH\u2082O, FiO\u2082 1.0 \u2014 increase IPAP to 15 and EPAP to 10 if no improvement \u2014 consult AV Medical Advisor via AV Clinician for further adjustments if no improvement" },
      { type: "note", items: ["GTN infusion if patient on NIV with BP > 140 mmHg (without vasopressors) and limited/no clinical improvement: Start 10 mcg/min (2 mL/hr), increase 10 mcg/min at 5 min intervals, target SBP 120\u2013140 mmHg, max 200 mcg/min (40 mL/hr), cease if SBP < 100 mmHg"] }
    ],
